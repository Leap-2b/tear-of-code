    ...
    <footer className="bg-black text-white">
      <div className="max-w-[1400px] m-auto px-4 py-12 md:px-6 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:flex justify-between">
          <div>
            <h3 className="mb-4 text-xl font-bold">StyleCut</h3>
          ...
          <div>
            <h3 className="mb-4 text-xl font-bold">Холбоосууд</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/staffs" className="text-gray-400 hover:text-white">
                  Манай ажилчид
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="mb-4 text-xl font-bold">Холбоо барих</h3>
